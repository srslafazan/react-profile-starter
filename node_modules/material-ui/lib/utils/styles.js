...
var warn = function warn() {
  process.env.NODE_ENV !== "production" ? (0, _warning2.default)(hasWarned, 'The \'material-ui/lib/utils/styles.js\' utility module has been deprecated.' + ' Please do not use this utility module as it will be removed in an upcoming release.') : undefined;
  hasWarned = true;
};
